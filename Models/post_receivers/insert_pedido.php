...
// $printer->text("-----------------------------------------\n");
   ...
   $pedido->execute(array($_POST['cliente'],json_encode($_POST['produtos']),$_POST['data_entrega'],$_POST['data_pedido'],$_POST['retirada'],$_POST['pagamento'],$_POST['endereco'],$_POST['caixa']));
   ...
   foreach ($_POST['produtos'] as $key => $value) {
    ...
    $produto->execute(array('luis',date("Y-m-d h:i:sa"),$value['preco']*$value['quantidade'],$_POST['caixa'],$value['id'],$_POST['pagamento'],$lastInsertedId));
